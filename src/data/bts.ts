...
export const btsGear = [
  {
    eyebrow: 'Ducted Cinewhoop',
    title: 'Built for tight spaces.',
    paras: [
      "Our ducted cinewhoop is a small, fully enclosed FPV drone purpose-built for indoor use. The propeller guards keep it safe around people, furniture, and narrow doorways — letting us fly through spaces that standard drones simply can't enter. It moves at a natural walking pace through rooms, hallways, and staircases in a single unbroken take. No cuts. No resets. Just one continuous move from the front door through every room.",
      'This is the drone responsible for the FPV flythroughs that make listings and venues look the way they actually feel to walk through.'
    ],
  },
  {
    eyebrow: 'DJI Drone',
...
export const btsCredentials = [
  { title: 'FAA Part 107 Certified', body: 'Commercial drone pilot certification, current and in good standing.' },
  { title: 'Licensed Insured', body: 'Full coverage on every shoot. COI available same-day on request.' },
  { title: 'Charlotte & Beyond', body: 'Based in Charlotte, traveling regularly across the Carolinas for the right project.' },
  { title: 'USA Wide Available', body: 'Available for projects across all 50 states. Travel costs are quoted transparently upfront — no surprises.' }
];
